...
export const initialNodes = [
  ...
  createNode('Celula', '1. Célula', { x: 150, y: 100 }, 'fundamentales'),
  createNode('TeoriaCelular', '2. Teoría celular', { x: 150, y: 220 }, 'fundamentales'),
  createNode('CicloVida', '3. Ciclo de vida celular', { x: 400, y: 140 }, 'fundamentales'),
  createNode('ViaMetabolica', '4. Vía metabólica', { x: 400, y: 280 }, 'fundamentales'),
  createNode('Eucariota', '22. Célula eucariota', { x: 150, y: 360 }, 'fundamentales'),
  createNode('Procariota', '23. Célula procariota', { x: 150, y: 500 }, 'fundamentales'),
  
  // Estructura y Genética (centro)
  createNode('ADN', '5. ADN', { x: 750, y: 100 }, 'estructurales'),
  createNode('ARN', '6. ARN', { x: 750, y: 220 }, 'estructurales'),
  createNode('Nucleotido', '16. Nucleótido', { x: 1000, y: 100 }, 'estructurales'),
  createNode('Bases', '17. Bases nitrogenadas', { x: 1250, y: 100 }, 'estructurales'),
  createNode('Chargaff', '18. Regla de Chargaff', { x: 1500, y: 100 }, 'estructurales'),
  createNode('DobleHelice', '19. Doble hélice', { x: 1000, y: 220 }, 'estructurales'),
  createNode('Complementariedad', '20. Complementariedad de bases', { x: 1250, y: 220 }, 'estructurales'),
  createNode('Cromosoma', '9. Cromosoma', { x: 750, y: 360 }, 'estructurales'),
  createNode('Gen', '10. Gen', { x: 1000, y: 360 }, 'estructurales'),
  createNode('Exon', '24. Exón', { x: 1250, y: 360 }, 'estructurales'),
  createNode('Intron', '25. Intrón', { x: 1250, y: 500 }, 'estructurales'),
  createNode('HerenciaMendeliana', '11. Herencia mendeliana', { x: 750, y: 640 }, 'estructurales'),
  createNode('Mutacion', '12. Mutación', { x: 1000, y: 640 }, 'estructurales'),
  createNode('Ligamiento', '13. Ligamiento genético', { x: 750, y: 780 }, 'estructurales'),
  createNode('MapaGenetico', '14. Mapa genético', { x: 1000, y: 780 }, 'estructurales'),
  createNode('UnGenUnaProteina', '15. Un gen-una proteína', { x: 1000, y: 500 }, 'estructurales'),
  createNode('AlfabetoMolecular', '8. Alfabeto molecular', { x: 1000, y: 920 }, 'estructurales'),
  createNode('Proteina', '7. Proteína', { x: 400, y: 920 }, 'traduccion'),
  
  // Dogma Central y Transcripción
  createNode('DogmaCentral', '41. Dogma central', { x: 750, y: 1060 }, 'procesos'),
  createNode('Replicacion', '21. Replicación del ADN', { x: 400, y: 1200 }, 'procesos'),
  createNode('Transcripcion', '26. Transcripción', { x: 1000, y: 1200 }, 'procesos'),
  createNode('ARNPolimerasa', '27. ARN polimerasa', { x: 1250, y: 1200 }, 'procesos'),
  createNode('ARNm', '28. ARN mensajero', { x: 1000, y: 1340 }, 'procesos'),
  createNode('Splicing', '29. Splicing', { x: 1250, y: 1340 }, 'procesos'),
  
  // Traducción y Proteínas
  createNode('Traduccion', '30. Traducción', { x: 400, y: 1480 }, 'traduccion'),
  createNode('Ribosoma', '31. Ribosoma', { x: 150, y: 1620 }, 'traduccion'),
  createNode('Aminoacido', '32. Aminoácido', { x: 400, y: 1620 }, 'traduccion'),
  createNode('Polipeptido', '33. Polipéptido', { x: 150, y: 1760 }, 'traduccion'),
  createNode('Codon', '34. Codón', { x: 650, y: 1620 }, 'traduccion'),
  createNode('CodigoGenetico', '35. Código genético', { x: 900, y: 1620 }, 'traduccion'),
  createNode('Degeneracion', '36. Degeneración del código genético', { x: 1150, y: 1620 }, 'traduccion'),
  createNode('CodonInicio', '37. Codón de inicio', { x: 900, y: 1760 }, 'traduccion'),
  createNode('CodonTerminacion', '38. Codón de terminación', { x: 1150, y: 1760 }, 'traduccion'),
  createNode('ARNt', '39. ARN de transferencia', { x: 650, y: 1900 }, 'traduccion'),
  createNode('Anticodon', '40. Anticodón', { x: 900, y: 1900 }, 'traduccion'),
  
  // Técnicas Moleculares (columna derecha)
  createNode('PCR', '42. PCR', { x: 1750, y: 100 }, 'tecnicas'),
  createNode('Cebador', '43. Cebador/Primer', { x: 2000, y: 100 }, 'tecnicas'),
  createNode('Desnaturalizacion', '44. Desnaturalización', { x: 1750, y: 240 }, 'tecnicas'),
  createNode('Alineamiento', '45. Alineamiento/Priming', { x: 2000, y: 240 }, 'tecnicas'),
  createNode('Extension', '46. Extensión', { x: 1750, y: 380 }, 'tecnicas'),
  createNode('ClonacionMolecular', '47. Clonación molecular', { x: 1750, y: 640 }, 'tecnicas'),
  createNode('Vector', '48. Vector de clonación', { x: 2000, y: 640 }, 'tecnicas'),
  createNode('BibliotecaClones', '49. Biblioteca de clones', { x: 2000, y: 780 }, 'tecnicas'),
  createNode('EnzimaRestriccion', '50. Enzima de restricción', { x: 1750, y: 920 }, 'tecnicas'),
  createNode('SitioReconocimiento', '51. Sitio de reconocimiento', { x: 2000, y: 920 }, 'tecnicas'),
  createNode('ExtremosRomos', '52. Extremos romos', { x: 1750, y: 1060 }, 'tecnicas'),
  createNode('ExtremosPegajosos', '53. Extremos pegajosos', { x: 2000, y: 1060 }, 'tecnicas'),
  createNode('Hibridacion', '54. Hibridación', { x: 1750, y: 1200 }, 'tecnicas'),
  createNode('Ligacion', '55. Ligación', { x: 2000, y: 1200 }, 'tecnicas'),
  createNode('Electroforesis', '56. Electroforesis en gel', { x: 1750, y: 1340 }, 'tecnicas'),
  createNode('Sonda', '57. Sonda', { x: 2000, y: 1340 }, 'tecnicas'),
  createNode('Microarreglo', '58. Microarreglo', { x: 2000, y: 1480 }, 'tecnicas'),
  
  // Genómica y Evolución (abajo derecha)
  createNode('VariacionGenetica', '59. Variación genética intraespecífica', { x: 1750, y: 1760 }, 'genomica'),
  createNode('GenomaReferencia', '60. Genoma de referencia', { x: 2000, y: 1760 }, 'genomica'),
  createNode('Conservacion', '61. Conservación genética', { x: 1750, y: 1900 }, 'genomica'),
  createNode('Evolucion', '62. Evolución', { x: 1400, y: 2040 }, 'genomica'),
  createNode('SeleccionNatural', '63. Selección natural', { x: 1150, y: 2040 }, 'genomica'),
  createNode('Adaptacion', '64. Adaptación', { x: 1150, y: 2180 }, 'genomica'),
  createNode('Especiacion', '65. Especiación', { x: 1400, y: 2180 }, 'genomica'),
  createNode('GenomicaComparativa', '66. Genómica comparativa', { x: 1750, y: 2040 }, 'genomica'),
  createNode('AlineamientoSecuencias', '67. Alineamiento de secuencias', { x: 2000, y: 2040 }, 'genomica'),
  createNode('BLAST', '68. BLAST', { x: 2000, y: 2180 }, 'genomica'),
  createNode('Bioinformatica', '69. Bioinformática', { x: 1750, y: 2180 }, 'genomica'),
];
